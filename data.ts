  ...
  "research_papers": [
    {
      ...
      "venue": "Preparing",
      "year": 2025,
      "description": "Theoretical and numerical study of Gottesman-Kitaev-Preskill (GKP) codes under pure-loss decoherence. Developed an energy-scaled zero-noise extrapolation method for quantum error mitigation in bosonic codes.",
      "tags": [
        "Quantum Computing",
        "Error Mitigation"
      ],
